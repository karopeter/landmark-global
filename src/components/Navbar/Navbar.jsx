    ...
    <div className="right-end">
       ...
       <li className="menu-item">
            <Link to="" className="menu" onClick={toggleContact}>
              Contact Us <FontAwesomeIcon icon={faChevronDown} className={`dropdown-icon ${isContactOpen ? 'open' : ''}`} />
            </Link>
            {isContactOpen && (
              <div className="dropdown">
                <Link to="" className="dropdown-item">Tracking Portal</Link>
                <Link to="" className="dropdown-item">Business Enquiries</Link>
              </div>
            )}
          </li>
          <li className="menu-item">
            <Link to="" className="menu" onClick={toggleTracking}>
              Tracking <FontAwesomeIcon icon={faChevronDown} className={`dropdown-icon ${isTrackingOpen ? 'open' : ''}`} />
            </Link>
            {isTrackingOpen && (
              <div className="dropdown">
                <Link to="" className="dropdown-item">Mercury</Link>
                <Link to="/tracking" className="dropdown-item">Tracking</Link>
              </div>
            )}
          </li>
          <li className="menu-item">
            <Link to="" className="menu" onClick={toggleUnitedStates}>
              United States & Canada - EN <FontAwesomeIcon icon={faChevronDown} className={`dropdown-icon ${isUnitedStatesOpen ? 'open' : ''}`} />
            </Link>
            {isUnitedStatesOpen && (
              <div className="dropdown">
    ...
    <div className="navbar">
      ...
      <ul  className={`navbar-menu ${isMenuOpen ? 'open' : ''}`}>
        <li className="menu-item">
          ...
          {isSolutionsOpen && (
            <div className="dropdown">
              <Link to="" className="dropdown-item">Parcel Delivery</Link>
